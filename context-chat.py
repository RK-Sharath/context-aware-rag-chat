...
genai_api_url = st.sidebar.text_input("GenAI API URL", type="password", value="https://bam-api.res.ibm.com/v2?version=2023-11-22")
...
# Use RecursiveCharacterTextSplitter as the default and only text splitter
    ...
    if uploaded_files:
        ...
        llm=LangChainInterface(model="meta-llama/llama-2-70b-chat", parameters=params, client=Client(credentials=creds))
